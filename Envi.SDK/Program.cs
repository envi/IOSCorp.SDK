...
internal class Program
{
	...
	static Program()
	{
		...
		var invGroupString = configurationManager["inventoryGroupId"];
		...
		{
			throw new ArgumentException("Some of the required configuration values are missing. Please check AppSetting section of appsettings.json.");
		}
